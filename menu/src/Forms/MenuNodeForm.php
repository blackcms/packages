...
class MenuNodeForm extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        $id = $this->getModel()->id ?? "new";

        $this->withCustomFields()->add("title", "text", [
            ...
            "attr" => [
                ...
                "data-old" => $this->getModel()->title,
                "id" => "menu-node-title-" . $id,
            ],
        ]);

        if (!$this->getModel()->reference_id) {
            $this->add("url", "text", [
                ...
                "attr" => [
                    "placeholder" => trans(
                        "packages/menu::menu.url_placeholder"
                    ),
                    "data-old" => $this->getModel()->url,
                    "id" => "menu-node-url-" . $id,
                ],
            ]);
        }

        $this->add("icon_font", "text", [
            ...
            "attr" => [
                ...
                "data-old" => $this->getModel()->icon_font,
            ...
            ->add("css_class", "text", [
                ...
                "attr" => [
                    "placeholder" => trans(
                        "packages/menu::menu.css_class_placeholder"
                    ),
                    "data-old" => $this->getModel()->css_class,
