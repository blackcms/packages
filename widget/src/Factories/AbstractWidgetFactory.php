...
namespace BlackCMS\Widget\Factories;

use BlackCMS\Widget\AbstractWidget;
use BlackCMS\Widget\Contracts\ApplicationWrapperContract;
use BlackCMS\Widget\Misc\InvalidWidgetClassException;
use BlackCMS\Widget\Misc\ViewExpressionTrait;
...
abstract class AbstractWidgetFactory
{
    ...
    protected function instantiateWidget(array $params = [])
    {
        ...
        $this->widgetName = $this->parseFullWidgetNameFromString(
            array_shift($params)
        );
