...
namespace BlackCMS\Widget;

use BlackCMS\Widget\Contracts\ApplicationWrapperContract;
...
class WidgetGroupCollection
{
    ...
    public function group($sidebarId)
    {
        ...
        $this->groups[$sidebarId] = new WidgetGroup(
            ["id" => $sidebarId, "name" => $sidebarId],
            $this->app
        );
    ...
    protected function read()
    {
        ...
        return app(WidgetInterface::class)->allBy([
            "theme" => Theme::getThemeName() . $languageCode,
        ]);
    }
