...
class WidgetController extends BaseController
{
    ...
    public function index()
    {
        ...
        Assets::addScripts(["sortable"])->addScriptsDirectly(
            "vendor/core/packages/widget/js/widget.js"
        );
     ...
     */
    public function postSaveWidgetToSidebar(
        Request $request,
    ...
    public function postDelete(Request $request, BaseHttpResponse $response)
    {
        try {
            ...
            return $response->setMessage(
                trans("packages/widget::widget.delete_success")
            );
        } catch (Exception $exception) {
            return $response->setError()->setMessage($exception->getMessage());
        }
    ...
    public function showWidget(Request $request, Application $application)
    {
        ...
        $factory = $application->make("blackcms.widget");
        $widgetName = $request->input("name", "");
        $widgetParams = $factory->decryptWidgetParams(
