...
@section('content')
    @php do_action(BASE_ACTION_TOP_FORM_CONTENT_NOTIFICATION, request(), WIDGET_MANAGER_MODULE_NAME) @endphp
    <div class="widget-main" id="wrap-widgets">
        <div class="row">
            <div class="col-sm-6">
                ...
                <ul id="wrap-widget-1">
                    @foreach (Widget::getWidgets() as $widget)
                        <li class="card" data-id="{{ $widget->getId() }}">
            ...
            <div class="col-sm-6" id="added-widget">
                {!! apply_filters(WIDGET_TOP_META_BOXES, null, WIDGET_MANAGER_MODULE_NAME) !!}
                <div class="row">
