...
return [
    ...
    "custom_header_js_placeholder" =>
        "JS in header of page, wrap it inside &#x3C;script&#x3E;&#x3C;/script&#x3E;",
    "custom_body_js" => "Body JS",
    "custom_body_js_placeholder" =>
        "JS in body of page, wrap it inside &#x3C;script&#x3E;&#x3C;/script&#x3E;",
    "custom_footer_js" => "Footer JS",
    "custom_footer_js_placeholder" =>
        "JS in footer of page, wrap it inside &#x3C;script&#x3E;&#x3C;/script&#x3E;",
    "custom_html" => "Custom HTML",
    "custom_header_html" => "Header HTML",
    "custom_header_html_placeholder" =>
        "HTML in header of page, no special tags: script, style, iframe...",
    "custom_body_html" => "Body HTML",
    "custom_body_html_placeholder" =>
        "HTML in body of page, no special tags: script, style, iframe...",
    "custom_footer_html" => "Footer HTML",
    "custom_footer_html_placeholder" =>
        "HTML in footer of page, no special tags: script, style, iframe...",
    "remove_theme_success" => "Remove theme successfully!",
    "theme_is_not_existed" => "This theme is not existed!",
    "remove" => "Remove",
    "remove_theme" => "Remove theme",
    "remove_theme_confirm_message" =>
        "Do you really want to remove this theme?",
    ...
    "missing_json_file" => "Missing file composer.json!",
    "theme_invalid" => "Theme is valid!",
    "published_assets_success" => "Publish assets for :themes successfully!",
    "cannot_remove_theme" =>
        'Cannot remove activated theme, please activate another theme before removing ":name"!',
    ...
    "folder_is_not_writeable" =>
        "Cannot write files! Folder :name is not writable. Please chmod to make it writable!",
];
