...
use BlackCMS\Theme\Facades\AdminBarFacade;
use BlackCMS\Theme\Facades\ThemeOptionFacade;
use BlackCMS\Theme\Supports\AdminBar as AdminBarBase;
...
if (!function_exists("theme_option")) {
    /**
     * @return \BlackCMS\Theme\ThemeOption|string
     */
