...
namespace BlackCMS\Theme\Commands;

use BlackCMS\Setting\Models\Setting as SettingModel;
use BlackCMS\Theme\Commands\Traits\ThemeTrait;
...
class ThemeRenameCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $themeOptions = SettingModel::where(
            "key",
            "LIKE",
            "theme-" . $theme . "-%"
        )->get();
        ...
        $this->info(
            'Theme "' . $theme . '" has been renamed to ' . $newName . "!"
        );
