    ...
    public function buildForm()
    {
        $this->setupModel(new BaseModel())
            ...
            ->add("header_html", "textarea", [
                ...
                "help_block" => [
                    "text" => trans(
                        "packages/theme::theme.custom_header_html_placeholder"
                    ),
                ],
                "attr" => [
                    "data-counter" => 2500,
            ...
            ->add("body_html", "textarea", [
                ...
                "help_block" => [
                    "text" => trans(
                        "packages/theme::theme.custom_body_html_placeholder"
                    ),
                ],
                "attr" => [
                    "data-counter" => 2500,
            ...
            ->add("footer_html", "textarea", [
                ...
                "help_block" => [
                    "text" => trans(
                        "packages/theme::theme.custom_footer_html_placeholder"
                    ),
                ],
                "attr" => [
                    "data-counter" => 2500,
