...
use BlackCMS\Theme\Supports\Vimeo;
use BlackCMS\Theme\Supports\Youtube;
use Html;
    ...
    public function boot()
    {
        ...
        theme_option()
            ...
            ->setSection([
                ...
                "desc" => trans(
                    "packages/theme::theme.theme_option_general_description"
                ),
                "priority" => 300,
                ...
                "fields" => [
                    [
                        ...
                        "type" => "text",
                        "label" => trans(
                            "core/setting::setting.general.site_title"
                        ),
                        "attributes" => [
                            "name" => "site_title",
                            "value" => null,
                    ...
                    [
                        ...
                        "type" => "customSelect",
                        "label" => trans(
                            "core/setting::setting.general.show_site_name"
                        ),
                        "attributes" => [
                            "name" => "show_site_name",
                            "list" => [
                    ...
                    [
                        ...
                        "type" => "text",
                        "label" => trans(
                            "core/setting::setting.general.seo_title"
                        ),
                        "attributes" => [
                            "name" => "seo_title",
                            "value" => null,
                    ...
                    [
                        ...
                        "type" => "textarea",
                        "label" => trans(
                            "core/setting::setting.general.seo_description"
                        ),
                        "attributes" => [
                    ...
                    [
                        ...
                        "type" => "mediaImage",
                        "label" => trans(
                            "packages/theme::theme.theme_option_seo_open_graph_image"
                        ),
                        "attributes" => [
                            "name" => "seo_og_image",
                            "value" => null,
            ...
            ->setSection([
                ...
                "fields" => [
                    [
                        ...
                        "type" => "mediaImage",
                        "label" => trans(
                            "packages/theme::theme.theme_option_favicon"
                        ),
                        "attributes" => [
                            "name" => "favicon",
                            "value" => null,
                    ...
                    [
                        ...
                        "type" => "mediaImage",
                        "label" => trans(
                            "packages/theme::theme.theme_option_logo"
                        ),
                        "attributes" => [
                            "name" => "logo",
                            "value" => null,
        ...
        add_shortcode("media", null, null, function ($shortcode) {
            ...
            if ($iframe) {
                return Html::tag("div", $iframe, [
                    "class" => "embed-responsive embed-responsive-16by9 mb30",
                ])->toHtml();
            }
