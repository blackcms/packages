...
namespace BlackCMS\Seo\Bases;

use BlackCMS\Seo\Contracts\Entities\MetaCollectionContract;
use BlackCMS\Seo\Contracts\Helpers\MetaContract;
use BlackCMS\Seo\Contracts\RenderableContract;
use BlackCMS\Seo\Helpers\Meta;
use Illuminate\Support\Collection;

abstract class MetaCollection extends Collection implements
    MetaCollectionContract
{
    /**
     * Meta tag prefix.
     *
