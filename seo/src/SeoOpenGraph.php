...
use BlackCMS\Seo\Contracts\Entities\OpenGraphContract;
...
class SeoOpenGraph implements SeoOpenGraphContract
{
    ...
    {
        $this->setOpenGraph(new Entities\OpenGraph\Graph());
    }
    ...
    public function render()
    {
        if (!$this->hasImage() && theme_option("seo_og_image")) {
            $this->setImage(MediaManagement::url(theme_option("seo_og_image")));
        }
