...
use BlackCMS\Page\Repositories\Caches\PageCacheDecorator;
use BlackCMS\Page\Repositories\Eloquent\PageRepository;
...
class PageServiceProvider extends ServiceProvider
{
    ...
    {
        $this->setNamespace("packages/page")->loadHelpers();
    }
    ...
    public function boot()
    {
        ...
        Event::listen(RouteMatched::class, function () {
            ...
            if (function_exists("admin_bar")) {
                Theme::composer("*", function () {
                    if (Auth::check() &&
                        Auth::user()->hasPermission("pages.create")
                    ) {
        ...
        if (function_exists("shortcode")) {
            view()->composer(["packages/page::themes.page"], function (
                View $view
            ) {
                $view->withShortcodes();
            });
