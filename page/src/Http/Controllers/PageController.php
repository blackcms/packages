...
namespace BlackCMS\Page\Http\Controllers;
...
use BlackCMS\Page\Forms\PageForm;
use BlackCMS\Page\Http\Requests\PageRequest;
use BlackCMS\Page\Repositories\Interfaces\PageInterface;
use BlackCMS\Page\Tables\PageTable;
use Exception;
...
class PageController extends BaseController
{
    ...
    {
        $page = $this->pageRepository->createOrUpdate(
            array_merge($request->input(), [
                "user_id" => Auth::id(),
            ])
        );

        event(new CreatedContentEvent(PAGE_MODULE_NAME, $request, $page));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(
            trans("packages/page::pages.edit") . ' "' . $page->name . '"'
        );

        event(new BeforeEditContentEvent($request, $page));

        return $formBuilder
            ->create(PageForm::class, ["model" => $page])
            ->renderForm();
    }
    ...
    public function update(
        ...
        event(new UpdatedContentEvent(PAGE_MODULE_NAME, $request, $page));
    ...
    public function destroy(Request $request, $id, BaseHttpResponse $response)
    {
        try {
            ...
            event(new DeletedContentEvent(PAGE_MODULE_NAME, $request, $page));
