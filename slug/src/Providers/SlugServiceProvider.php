...
use BlackCMS\Slug\Repositories\Caches\SlugCacheDecorator;
use BlackCMS\Slug\Repositories\Eloquent\SlugRepository;
...
class SlugServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->setNamespace("packages/slug")->loadHelpers();
    }
    ...
    public function boot()
    {
        ...
        $this->app->booted(function () {
            ...
            foreach (array_keys(
                $this->app->make(SlugHelper::class)->supportedModels()
            ) as $item) {
                ...
                MacroableModels::addMacro(
                    ...
                    function () {
                        ...
                        if (get_class($this) == Page::class &&
                            BaseHelper::isHomepage($this->id)
                        ) {
                            return url("");
                        }

                        $prefix = $this->slugable
                            ? $this->slugable->prefix
                            : null;
