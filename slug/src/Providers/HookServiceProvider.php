...
use BlackCMS\Slug\Forms\Fields\PermalinkField;
use Eloquent;
...
class HookServiceProvider extends ServiceProvider
{
    ...
    public function addSlugBox($html = null, $object = null)
    {
        if ($object && SlugHelper::isSupportedModel(get_class($object))) {
            Assets::addScriptsDirectly(
                "vendor/core/packages/slug/js/slug.js"
     ...
     * @return FormAbstract
     */
    public function addCustomFormFields(
        FormAbstract $form,
        FormHelper $formHelper
    ) {
        if (!$formHelper->hasCustomField("permalink") &&
            SlugHelper::supportedModels()
        ) {
